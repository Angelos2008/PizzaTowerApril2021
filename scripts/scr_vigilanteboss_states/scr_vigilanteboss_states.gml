function vigilante_cancel_attack() //vigilante_cancel_attack
{
    if (cancel_buffer > 0)
        cancel_buffer--
...
function boss_vigilante_decide_attack() //boss_vigilante_decide_attack
{
    if (phase < 3)
...
function vigilante_decide_attack_phase6_nohonor() //vigilante_decide_attack_phase6_nohonor
{
...
function vigilante_decide_attack_phase5() //vigilante_decide_attack_phase5
{
    if (attack_cooldown > 0)
        attack_cooldown--
    else
...
function vigilante_decide_attack_phase4() //vigilante_decide_attack_phase4
{
    if (attack_cooldown > 0)
        attack_cooldown--
    else
    {
        ...
        state = choose((136 << 0), (101 << 0), (138 << 0))
        if (state == (101 << 0))
        {
            sprite_index = spr_playerV_divekickstart
            image_index = 0
...
function vigilante_decide_attack_phase3() //vigilante_decide_attack_phase3
{
    if (attack_cooldown > 0)
        attack_cooldown--
    else
...
function vigilante_decide_attack_phase1() //vigilante_decide_attack_phase1
{
    if (attack_cooldown > 0)
        attack_cooldown--
    else
    {
        targetstunned = 0
        attack_cooldown = attack_max[(phase - 1)]
        state = choose((79 << 0), (79 << 0), (1 << 0), (1 << 0), (1 << 0), (68 << 0), (68 << 0))
        if (state == (1 << 0))
        {
...
function vigilante_decide_normalattack() //vigilante_decide_normalattack
{
...
{
    image_speed = 0.35
    if (targetplayer.hsp != 0 && targetplayer.state != (128 << 0) && distance_to_object(targetplayer) < 500)
...
{
    image_speed = 0.35
    if (targetplayer.hsp != 0 && targetplayer.state != (128 << 0) && distance_to_object(targetplayer) < 480)
        move = sign(targetplayer.hsp)
    else
        move = 0
...
function boss_vigilante_float() //boss_vigilante_float
{
    image_speed = 0.35
...
function boss_vigilante_revolver() //boss_vigilante_revolver
{
    ...
    if (phase > 4)
        vigilante_cancel_attack((2 << 0), (101 << 0))
}
...
function boss_vigilante_mach1() //boss_vigilante_mach1
{
    ...
    if (phase > 4)
        vigilante_cancel_attack(((!honor) ? (1 << 0) : (31 << 0)), (101 << 0))
}
...
function boss_vigilante_crouchslide() //boss_vigilante_crouchslide
{
    ...
    if (phase > 4)
        vigilante_cancel_attack((136 << 0), (101 << 0), (59 << 0))
}
...
function boss_vigilante_jump() //boss_vigilante_jump
{
    image_speed = (phase != 6 ? 0.35 : 0.5)
    hsp = (image_xscale * movespeed)
...
function boss_vigilante_charge() //boss_vigilante_charge
{
...
function boss_vigilante_punch() //boss_vigilante_punch
{
    image_speed = (phase != 6 ? 0.35 : 0.5)
    hsp = (image_xscale * movespeed)
    if place_meeting((x + sign(hsp)), y, obj_solid)
    ...
    if (phase > 4)
        vigilante_cancel_attack((136 << 0), (59 << 0))
}
...
function boss_vigilante_freefallprep() //boss_vigilante_freefallprep
{
...
function boss_vigilante_freefall() //boss_vigilante_freefall
{
    if (x > (targetplayer.x - 24) && x < (targetplayer.x + 24))
    {
        move = 0
...
function boss_vigilante_freefallland() //boss_vigilante_freefallland
{
    hsp = (image_xscale * movespeed)
    image_speed = (phase != 6 ? 0.35 : 0.5)
    if (image_index > (image_number - 1))
        state = (0 << 0)
    if (phase > 4)
        vigilante_cancel_attack(((!honor) ? (1 << 0) : (31 << 0)), (59 << 0))
}
...
function boss_vigilante_uppunch() //boss_vigilante_uppunch
{
    ...
    if grounded
        state = (0 << 0)
    if (phase > 4)
        vigilante_cancel_attack((31 << 0), (59 << 0))
}
...
function boss_vigilante_superattack() //boss_vigilante_superattack
{
    if (duel_buffer > 0)
    {
        if (lastplayerid.state != (110 << 0) && lastplayerid.state != (128 << 0))
            duel_buffer--
    }
    ...
    with (lastplayerid)
    {
        if (state != (132 << 0) && state != (110 << 0) && state != (128 << 0) && state != (43 << 0))
        {
            state = (132 << 0)
            x = (room_width / 3)
        }
