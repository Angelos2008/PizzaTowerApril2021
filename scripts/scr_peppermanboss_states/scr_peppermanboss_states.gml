...
function pepperman_decide_attack_phase5() //pepperman_decide_attack_phase5
{
    ...
    else
    {
        ...
        groundpound_fakeout = 1
        readjusting = 0
        state = (irandom(100) > 50 ? choose((101 << 0), (101 << 0), (60 << 0)) : (68 << 0))
        if (state == (101 << 0))
        {
            sprite_index = spr_pepperman_shoulderstart
            image_index = 0
...
function pepperman_decide_attack_phase1() //pepperman_decide_attack_phase1
{
    ...
    else
    {
        ...
        state = (irandom(100) > chance_shoulder ? (125 << 0) : (68 << 0))
...
{
    self.boss_pepperman_arenaround()
    var c = 0
    with (obj_player)
    {
