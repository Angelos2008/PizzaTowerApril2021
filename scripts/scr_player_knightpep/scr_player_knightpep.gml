function scr_player_knightpep() //scr_player_knightpep
{
    ...
    if (sprite_index == spr_knightpepland || sprite_index == spr_knightpepwalk || sprite_index == spr_knightpepjump || sprite_index == spr_knightpepfall || sprite_index == spr_knightpepidle)
    {
        move = (key_left + key_right)
        hsp = (move * movespeed)
    }
    else if (sprite_index == spr_knightpep_attack)
