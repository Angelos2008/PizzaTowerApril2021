function scr_player_grabbed() //scr_player_grabbed
{
    ...
    if (_obj_player.state == (94 << 0) && fightball == 1)
    {
        x = _obj_player.x
        y = _obj_player.y
    }
    ...
    with (_obj_player)
    {
        ...
        if (!((state == (56 << 0) || (state == (94 << 0) && fightball == 1) || state == (6 << 0) || state == (37 << 0) || state == (51 << 0) || state == (52 << 0) || state == (16 << 0) || state == (57 << 0) || state == (53 << 0) || state == (58 << 0) || state == (59 << 0) || state == (60 << 0))))
        {
            baddiegrabbedID = 298
    ...
    if (_obj_player.state == (53 << 0) && _obj_player.sprite_index == _obj_player.spr_piledriver)
    {
