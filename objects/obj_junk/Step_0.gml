...
if (grabbed == 1)
{
    ...
    if (playerid.state == (6 << 0) || playerid.state == (37 << 0) || playerid.state == (56 << 0) || playerid.state == (51 << 0) || playerid.state == (52 << 0) || playerid.state == (16 << 0))
    {
        thrown = 0
        grav = 0
        grounded = 0
    ...
    with (playerid)
    {
        ...
        if (!((state == (6 << 0) || state == (56 << 0) || state == (37 << 0) || state == (51 << 0) || state == (52 << 0) || state == (16 << 0) || state == (57 << 0) || state == (53 << 0) || state == (58 << 0) || state == (59 << 0) || state == (60 << 0))))
        {
            other.grav = 0.5
            other.x = x
            other.y = y
    ...
    if (playerid.state == (56 << 0) && playerid.sprite_index == playerid.spr_swingding)
    {
