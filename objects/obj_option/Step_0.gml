...
if (optionselected == 0)
{
    if ((obj_player.key_right2 || keyboard_check_pressed(vk_right)) && optionsaved_fullscreen == false)
        optionsaved_fullscreen = true
    if (((-obj_player.key_left2) || keyboard_check_pressed(vk_left)) && optionsaved_fullscreen == true)
