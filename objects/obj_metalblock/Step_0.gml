with (obj_player1)
{
    if (character != "V")
    {
        if ((place_meeting((x + hsp), y, other) || place_meeting((x + xscale), y, other)) && (obj_player1.state == (94 << 0) || obj_player1.state == (156 << 0) || obj_player1.state == (27 << 0) || obj_player1.state == (125 << 0)))
        {
            playerindex = 0
...
with (obj_player2)
{
    if ((place_meeting((x + hsp), y, other) || place_meeting((x + xscale), y, other)) && (obj_player2.state == (94 << 0) || obj_player2.state == (27 << 0) || obj_player2.state == (125 << 0)))
    {
        playerindex = 1
        instance_destroy(other)
    }
