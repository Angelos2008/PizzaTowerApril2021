if (image_index == 1 && global.panic == 0)
{
    with (obj_player)
    {
        if (state == (71 << 0) && floor(image_index) == (image_number - 2))
        {
...
with (obj_player)
{
    if (grounded && x > (other.x - 160) && x < (other.x + 160) && key_up && (state == (0 << 0) || state == (79 << 0) || state == (80 << 0) || state == (94 << 0)) && (global.panic == 1 || global.snickchallenge == 1))
    {
