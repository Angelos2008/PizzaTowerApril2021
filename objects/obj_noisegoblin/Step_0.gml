...
if (x != targetplayer.x && targetplayer.state != (36 << 0) && state != (102 << 0) && bombreset == 0 && grounded)
{
...
{
    if (x != obj_player2.x && obj_player2.state != (36 << 0) && state != (102 << 0) && bombreset == 0 && grounded)
    {
