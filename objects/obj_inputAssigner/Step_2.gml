...
with (obj_player)
{
    ...
    if (state != other.prevstate[_pindex])
    {
        ...
        {
            case (67 << 0):
                GamepadSetVibration(_pindex, 1, 0.8, 0.6)
                break
            case (5 << 0):
                GamepadSetVibration(_pindex, 1, 0.8, 0.8)
                break
            case (9 << 0):
                GamepadSetVibration(_pindex, 1, 1, 0.85)
                break
            case (10 << 0):
                GamepadSetVibration(_pindex, 1, 0.8, 0.85)
                break
            case (83 << 0):
                GamepadSetVibration(_pindex, 1, 1, 0.85)
                break
            ...
            case (33 << 0):
                ...
                break
            case (120 << 0):
                GamepadSetVibration(_pindex, 1, 0.8, 0.65)
                break
            case (87 << 0):
                GamepadSetVibration(_pindex, 1, 1, 0.85)
                break
            ...
            case (82 << 0):
                ...
                break
            case (31 << 0):
                GamepadSetVibration(_pindex, 1, 0.2, 0.9)
                break
            case (56 << 0):
                GamepadSetVibration(_pindex, 1, 0.2, 0.8)
                break
            default:
                GamepadSetVibration(_pindex, 0, 0, 0)
                break
        }
