...
ds_map_set(boss_hurtstates, (59 << 0), 30)
ds_map_set(boss_hurtstates, (31 << 0), 30)
ds_map_set(boss_hurtstates, (57 << 0), 60)
ds_map_set(boss_hurtstates, (138 << 0), 20)
ds_map_set(boss_hurtstates, (84 << 0), 60)
phase = 1
max_phase = 6
...
ds_map_set(cancel_max, (138 << 0), (millionpunch_max / 2))
ds_map_set(cancel_max, (136 << 0), 10)
ds_map_set(cancel_max, (1 << 0), 30)
ds_map_set(cancel_max, (79 << 0), 120)
combo_count = 0
duelintro_buffer = 0
duelintro_max = 240
...
function player_hurt(argument0) //boss_destroy_gml_Object_obj_vigilanteboss_Create_0
{
...
function player_hurt(argument0, argument1) //boss_hurt_gml_Object_obj_vigilanteboss_Create_0
{
    if (targetstunned > 0)
    {
...
function player_hurt(argument0) //boss_hurt_noplayer_gml_Object_obj_vigilanteboss_Create_0
{
    if (targetstunned > 0)
    {
        targetstunned -= targetstunnedminus[(phase - 1)]
...
function player_hurt(argument0, argument1) //player_hurt_gml_Object_obj_vigilanteboss_Create_0
{
