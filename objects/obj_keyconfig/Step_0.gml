...
if (selecting == -1)
{
    if (player == 0 && ((obj_player1.key_right2 && obj_player1.key_right2 != obj_player1.key_left2) || keyboard_check_pressed(vk_right)))
        player += 1
    if (player == 1 && (((-obj_player1.key_left2) && obj_player1.key_left2 != obj_player1.key_right2) || keyboard_check_pressed(vk_left)))
        player -= 1
}
...
if (key_select == 9 && (obj_player1.key_jump || keyboard_check_pressed(vk_return)) && selecting == -1 && player == 0)
{
    selecting = key_select
    global.key_start = -1
}
...
if (key_select == 9 && (obj_player2.key_jump || keyboard_check_pressed(vk_return)) && selecting == -1 && player == 1)
{
    selecting = key_select
    global.key_startN = -1
}
