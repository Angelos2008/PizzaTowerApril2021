...
playerdestroyed = 0
colliding = 1
function boss_hurt_noplayer(argument0) //SUPER_player_destroy_gml_Object_par_boss_Create_0
{
...
function boss_hurt_noplayer(argument0) //SUPER_boss_destroy_gml_Object_par_boss_Create_0
{
    destroyed = 1
    depth = argument0.depth
    with (argument0)
    {
        camera_zoom(1, 0.1)
        if (state == (134 << 0) || state == (132 << 0) || state == (120 << 0) || state == (61 << 0))
        {
...
function boss_hurt_noplayer(argument0, argument1) //SUPER_boss_hurt_gml_Object_par_boss_Create_0
{
    if important
        hp -= argument0
    with (argument1)
    {
        ...
        lag = 8
        if (state == (43 << 0) || state == (110 << 0))
        {
            x = hitX
            y = hitY
        }
        if (other.state == (110 << 0) || other.state == (43 << 0))
        {
            other.x = other.hitX
            other.y = other.hitY
        }
...
function boss_hurt_noplayer(argument0) //SUPER_boss_hurt_noplayer_gml_Object_par_boss_Create_0
{
    if important
        hp -= argument0
    lag = 8
...
function boss_hurt_noplayer(argument0, argument1) //SUPER_player_hurt_gml_Object_par_boss_Create_0
{
    ...
    with (argument1)
    {
        ...
        if (other.state == (43 << 0) || other.state == (110 << 0))
        {
            other.x = other.hitX
            other.y = other.hitY
        }
...
function boss_hurt_noplayer(argument0) //player_destroy_gml_Object_par_boss_Create_0
{
    self.SUPER_player_destroy(argument0)
}

function boss_hurt_noplayer(argument0) //boss_destroy_gml_Object_par_boss_Create_0
{
    self.SUPER_boss_destroy(argument0)
}

function boss_hurt_noplayer(argument0, argument1) //player_hurt_gml_Object_par_boss_Create_0
{
    self.SUPER_player_hurt(argument0, argument1)
}

function boss_hurt_noplayer(argument0, argument1) //boss_hurt_gml_Object_par_boss_Create_0
{
