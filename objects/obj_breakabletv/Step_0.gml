...
if (grabbed == 1)
{
    ...
    if (obj_player.state == (37 << 0) || obj_player.state == (56 << 0) || obj_player.state == (51 << 0) || obj_player.state == (52 << 0) || obj_player.state == (16 << 0))
    {
        grounded = 0
        x = obj_player.x
    ...
    with (obj_player)
    {
        ...
        if (!((state == (56 << 0) || state == (37 << 0) || state == (51 << 0) || state == (52 << 0) || state == (16 << 0) || state == (57 << 0) || state == (53 << 0) || state == (58 << 0) || state == (59 << 0) || state == (60 << 0))))
        {
            other.x = x
            other.y = y
            other.grabbed = 0
